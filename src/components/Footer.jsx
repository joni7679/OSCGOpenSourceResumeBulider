...
const Footer = () => {
    return (
        <footer className="relative  bg-[#131010]  text-white pt-0 pb-10 overflow-hidden shadow-2xl">
            ...
            <div className="border-t border-gray-700 mt-10 pt-4 text-center text-gray-400 text-xs relative z-10 animate-fade-in">
                ...
                <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="ml-4 px-3 py-1 bg-gradient-to-r bg-blue-500  text-white rounded-full shadow hover:scale-110 transition-transform duration-300 text-xs focus:outline-none">Back to Top</button>
            </div>
        </footer>
    );
};
