            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div>
                <button
                  type="submit"
                  disabled={islogin}
                  className={`w-full py-3 text-white font-semibold cursor-pointer rounded-md bg-blue-600  transition ${islogin ? 'opacity-70 cursor-not-allowed' : 'hover:opacity-90'
                    }`}>
