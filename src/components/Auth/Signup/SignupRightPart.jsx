                        ...
                        <div className="space-y-5">
                            ...
                            <div>
                                <button
                                    type="submit"
                                    disabled={isSignup}
                                    className={`inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 border border-transparent rounded-md bg-blue-600 focus:outline-none hover:opacity-80 focus:opacity-80 ${isSignup ? "opacity-60 cursor-not-allowed" : "cursor-pointer"
                                        }`}>
